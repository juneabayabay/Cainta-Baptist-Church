...
export function Hero() {
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1080px] px-4 pt-28 pb-[calc(5rem+env(safe-area-inset-bottom,0px))] sm:px-6 sm:pt-32 sm:pb-24 lg:px-8 lg:pb-28">
        <div className="max-w-xl">
          ...
          <p className="hero-enter hero-enter-delay-2 mb-6 max-w-md text-[0.95rem] leading-relaxed text-white/90 sm:mb-7 sm:text-base">
            Tired or searching — Jesus offers rest, and this church family will
            walk with you.
          </p>

          <div className="hero-enter hero-enter-delay-2 mb-7 space-y-1 rounded-2xl border border-white/15 bg-white/10 px-4 py-3 text-sm text-white/90 backdrop-blur-sm sm:mb-8 sm:inline-block sm:px-5">
            <p>
