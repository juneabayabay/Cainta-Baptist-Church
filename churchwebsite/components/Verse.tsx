    ...
    <section id="verse" aria-label="Scripture" className="section-shell surface-white">
      <div className="section-inner section-inner-narrow text-center">
        <Reveal>
          <blockquote>
            <div
              className="mx-auto mb-5 h-px w-10 bg-primary sm:mb-6"
              aria-hidden
            />
            ...
            <footer className="mt-4 text-xs font-semibold tracking-[0.14em] text-secondary uppercase">
              {site.verse.reference}
            </footer>
            <div
              className="mx-auto mt-5 h-px w-10 bg-primary sm:mt-6"
              aria-hidden
            />
          </blockquote>
        </Reveal>
